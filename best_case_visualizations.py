...
# ============================================================
# DRIFT-SENSE BEST CASE VISUALIZATION
# ============================================================
...
OUTPUT_DIR = "dataset/final_analysis/best_case_visualizations"
...
print()
print("=" * 60)
print("       DRIFT-SENSE BEST CASE VISUALIZATION")
print("=" * 60)
print()
...
for _, row in best.iterrows():
    ...
    if image is None:
        print(f"Could not read: {search_path}")
        continue
    ...
    # Information
    text = f"{filename} | Error = {error:.2f} px"
...
print()
print("=" * 60)
print("       BEST CASE VISUALIZATION COMPLETE")
print("=" * 60)
print()